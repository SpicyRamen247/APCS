/**
 * Edited by Joshua Gao, Jacclyn Chen, Kosta Dubovskiy
 * Scrooge Playducks - Paul Serbanescu, Yuki Feng, Jaylen Zeng APCS Period 7
 * HW19: Mo Money Mo Problems ...MORE AWESOME 10/18/2021 DISCO: If statements
 * can evaluate multiple conditions: such as if x > 10 or x < 5 by using the ||
 * operator if x > 10 and x < 5 uses the && operator QCC:
 **/
...
}// end class BankAccountpublic class BankAccount {}